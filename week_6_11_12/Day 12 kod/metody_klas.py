...
# lepiej trzymac sie tego ze jak mamy  metode klasy to wywolujemy ja przez klase ale przez obiekt tez sie da
# taki konstruktor z którym cos jeszcze chcemy cos zrobic wazne aby taki obiekt zwracala "return"
